...
public  class ImageAdapter extends BaseAdapter {
    ...
    private static List<String> mSelectImg=new LinkedList<String>();
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ViewHolder vh=null;
        if (convertView==null){
            convertView=  mInflater.inflate(R.layout.tpitem,parent,false);
            vh=new ViewHolder();
            vh.mImg= (ImageView) convertView.findViewById(R.id.iv_item);
            vh.mSelect= (ImageButton) convertView.findViewById(R.id.ib_select);
