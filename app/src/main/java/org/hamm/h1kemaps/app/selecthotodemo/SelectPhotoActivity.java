...
import org.hamm.h1kemaps.app.adapter.ImageAdapter;
import org.hamm.h1kemaps.app.bean.FolderBean;
...
public class SelectPhotoActivity extends Activity {
    ...
    private void initEvent() {
        ...
        mBtnSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                List<String> photoPaths = adapter.selectPhoto();
                Intent intent = new Intent(SelectPhotoActivity.this, TPZSActivity.class);
